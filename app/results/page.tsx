...
export default function ResultsPage() {
  ...
  const filteredResults = results.filter((result) => {
    ...
    const matchesStage =
      stageFilter === "all" || result.evaluationStage === stageFilter
    const matchesStatus =
      statusFilter === "all" ||
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {filteredResults.length}件の評価結果を表示中
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredResults.map((result) => (
                    <TableRow key={`${result.workId}_${result.stage}`}>
                      <TableCell>
                        ...
                        <Dialog>
                          ...
                          <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                {result.evaluationStage}の詳細評価結果
                              </DialogDescription>
                            </DialogHeader>
                            ...
                            {selectedResult && (
                              <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                  ...
                                  <div>
                                    <span className="font-medium">評価日:</span>{" "}
                                    {selectedResult.evaluationDate}
                                  </div>
                                </div>
                              </div>
                            )}
